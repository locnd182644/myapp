...
#define CWMAP_CFG_FILE                  "/data/mifi/cwmap.cfg"
#define CWMAP_BOOTUP_CFG_FILE                  "/data/mifi/cwmap_bootup.cfg"
#define CWMAPCFG_CFG_FILE               "/data/mifi/cwmapcfg.cfg"
#define CWMAPCFG_FACTORY_CFG_FILE       "/data/mifi/cwmapcfg_factory.cfg"
#define CWNETCNCT_CFG_FILE              "/data/mifi/cwnetcnct.cfg"
#define CWCHANNEL_WIDTH_CFG_FILE                  "/data/mifi/cwchannelwidth.cfg"
#define CWMAP_CFG_NRT_FILE                  "/data/mifi/cwcfgnrt.cfg"

//#define MAP_CFG_FILE "/data/mobileap_enable_cfg" 
#define MAP_FIX_CFG_FILE "/data/mobileap_fix_enable_cfg" 

#define MAP_NETSTATUS_FILE "/data/net_status" 
#define GETWPASUPPLICANTCFG  "GetWpaSupplicantCfg"
#define SETWPASUPPLICANTCFG  "SetWpaSupplicantCfg"
#define GETSTAIP  "GetStaIP" //for AT+CWSTAIP, 
#define RTLSTAINIT "RtlStaInit"//for AT+CWSTAINIT, 
